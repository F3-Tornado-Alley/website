// Brand social icons (inline SVG, currentColor) shared by the footer + contact page.
      ...
      {SOCIALS.map((s) => (
        ...
        >
          <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
            <path d={s.path} {...(s.evenOdd ? { fillRule: "evenodd" as const, clipRule: "evenodd" as const } : {})} />
          </svg>
        </a>
      ))}
    </div>
