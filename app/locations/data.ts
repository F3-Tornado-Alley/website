// Central source of truth for our workout locations (AOs) and region.
// The locations page, the nav ticker, and the homepage stats all read from here.
...
// Stable anchor id for an AO, shared by the ticker links and the AO cards.
